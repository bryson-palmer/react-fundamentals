...
- **Raw React API** It was good exercise on using the raw React api to create an element and it's props and render it to the page.
- **unpkg.com** I learned that you can use unpkg.com to bring in different packages from npm by placing in a script tag the url for a specific package. Then you'll get access to all of the things that the package has to offer.
- **Declarative programming**
  - Imperative is focused more on the *How* to do something. Like, literally. Every step.
  - Declarative is focused more on *What* is happening without listing the steps of how it will get done. the 'under the hood' statement comes to mind.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=brysonpalmer%40gmail.com).
